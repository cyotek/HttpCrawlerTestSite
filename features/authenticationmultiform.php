...
<p>This form simulates form based authentication for web applications. Multiple forms are present on the page.</p>
...
<form method="post">
  <dl class="form-group">
    <dt><label for="search">Fake search</label></dt>
    <dd><input class="form-control" type="search" id="search" name="search"></dd>
  </dl>
...
<form method="post" action="index.php">
  <dl class="form-group">
    <dt><label for="search">Fake search</label></dt>
    <dd><input class="form-control" type="search" id="search2" name="search2"></dd>
  </dl>
  <div class="form-actions">
    <button name="submit" type="submit" class="btn btn-primary">Search</button>
  </div>
